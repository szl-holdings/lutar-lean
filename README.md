...
> The experimental library on `main` type-checks **CI-green** on Lean `v4.18.0` at [`75a4a311`](https://github.com/szl-holdings/lutar-lean/commit/75a4a3112287d3d4776d7d6da85a432f185f3914) (committed 2026-09-25; [`lake build + numbers`](https://github.com/szl-holdings/lutar-lean/actions/runs/36142969701) ✅, [Lean kernel check](https://github.com/szl-holdings/lutar-lean/actions/runs/36142969746) ✅). Measured at that SHA on 2026-09-25 with the canonical org counter ([`lean_numbers.py`](https://github.com/szl-holdings/.github/blob/907eb1f356c3d666131e74e476194ef1b4998ad4/.github/scripts/lean_numbers.py): line regexes over `Lutar/**/*.lean` + `Main.lean`, whole corpus): **2119 declarations / 34 axioms (33 unique) / 430 `sorry` tokens (378 non-comment)**. *Historical:* the figure previously shown here, 1323 declarations / 23 axioms (22 unique), was written on 2026-06-07 (`2038fd33`) and is superseded.
