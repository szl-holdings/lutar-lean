...
-- prove-wave-7: Mathlib-FREE discrete substrate (bare `lean` 4.13.0 verified, sorry-free;
...
-- card_nsmul_le_sum; McAllester COLT 1999). Signatures verified vs pinned Mathlib d7317655.
