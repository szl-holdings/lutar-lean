...
- `locked_count_five` — RE-ASSERTED invariant: the locked baseline is EXACTLY the
  five {F1,F11,F12,F18,F19}. Wave10 does NOT change this (`decide`).
- `wave10_excluded_from_locked` — the Wave10 theorem names are disjoint from the
  locked five: Wave10 is additive and excluded from the locked baseline.
...
/-- RE-ASSERTED locked invariant: exactly five locked theorems. Wave10 leaves this
unchanged. -/
