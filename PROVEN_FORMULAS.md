...
| Putnam 2025 set (experimental) | 12 faithful `Lutar/Putnam/P_A1..P_B6` statements of the **Putnam 2025** problems (honest REAL/DEMO/OPEN labels; deferred proofs are `sorry`) + 3 kernel-clean SZL originals under `Lutar/Putnam/SZL/` (no `sorry`, no new axiom). Forced kernel-compile via the `PutnamSet` `@[default_target]`. The internal "2023" tag was an error (drift). **Never in the locked count.** |
